    ...
    public SqsClient sqsClient() {
        return SqsClient.builder()
                ...
                .httpClientBuilder(ApacheHttpClient.builder()
                        ...
                        .connectionTimeout(Duration.ofSeconds(5))  // Reduced from 10
                        .socketTimeout(Duration.ofSeconds(15))  // Reduced from 30
                )
                .overrideConfiguration(ClientOverrideConfiguration.builder()
                        .retryPolicy(RetryPolicy.builder()
                                .numRetries(2)  // Reduced from 3 - fail faster
                                .build())
                        .apiCallTimeout(Duration.ofSeconds(20))  // Reduced from 30
                        .build()
                )
                .build();
    }
