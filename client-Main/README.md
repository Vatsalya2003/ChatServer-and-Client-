# Client Part 2 - Performance Analysis with Metrics

This client sends 500,000 messages and collects detailed performance metrics for analysis.

## What It Does

**Main Phase (MainPhase.java):**
- Generates 500,000 messages
- Creates 80 thread (chnage according to you)
...
### Method 1: Run Directly from IDE (Easiest)
...
3. **Update the URL in code:**
   - Open `MainPhase.java` in your IDE
   - Find the line with `Server_Url = ...`
   - Replace with your EC2 address
   - Save the file

4. **Run it:**
   - Right-click on `MainPhase.java`
   - Select "Run 'MainPhase.main()'"
   - Watch the console output
   - Wait for completion (~5-7 minutes)

5. **Check the results:**
   - Look in `Result/` folder for generated files
   - Review console output for statistics
   - Open throughput chart image
